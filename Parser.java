...
class Parser {
	...
	private Stmt classDeclaration() {
		...
		consume(TokenType.LEFT_SQUIGLY, "Expect '{' before class body");
		...
		consume(TokenType.RIGHT_SQUIGLY, "Expect '}' after class body");
	...
	private Stmt forStatement() {
		consume(TokenType.LEFT_BRACKET, "Expect '(' after 'for'");
		...
		consume(TokenType.RIGHT_BRACKET, "Expect ')' after for clauses");
		Stmt body = statement();
	...
	private Stmt ifStatement() {
		consume(TokenType.LEFT_BRACKET, "Expect '(' after 'if'.");
		Expr condition = expression();
		consume(TokenType.RIGHT_BRACKET, "Expect ')' after if condition");
	...
	private Stmt whileStatement() {
		consume(TokenType.LEFT_BRACKET, "Expect '(' after 'while'");
		Expr condition = expression();
		consume(TokenType.RIGHT_BRACKET, "Expect ')' after condition");
		Stmt body = statement();
